...
products_df = pd.read_pickle("04/fourth_task_products.json")
products_df = pd.DataFrame(products_df)
products_df["price"] = products_df["price"].astype(float)

with open("04/fourth_task_updates.json", "r", encoding="utf-8") as f:
...
products_df.to_pickle("04/modified_products_04.pkl")
